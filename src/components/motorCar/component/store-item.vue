<template>
    <div class="store-item" :class="{'choose-item': storeItem.checked}">
        <div class="store-detail">
            <div class="store-img">
                <img src="https://wsjc-web-1301582899.cos.ap-guangzhou.myqcloud.com/wsf-mall/motorCar/store-default.png" alt="">
            </div>
            <div class="detail-right">
                <div class="store-name">{{ storeItem.name }}</div>
                <div class="store-address">
                    <span class="distance">约{{ storeItem.distance  | filterDistance}}</span>
        ...
        <img class="checked-icon" v-if="storeItem.checked" src="https://wsjc-web-1301582899.cos.ap-guangzhou.myqcloud.com/wsf-mall/motorCar/store-checked.png" alt="">
    </div>
</template>
