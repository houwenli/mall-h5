    ...
    <div v-else @click="toDetails(item)">
      <div v-if="data" class="layout">
        ...
        <div class="shop-img" ref="shopImg">
          <img v-if="data.baseLabel.url" :src="data.baseLabel.url" alt="" style="height: 100%; width: 100%;object-fit: cover" />
          <img
            v-else
        ...
        <div class="shop-info" :class="{ 'disable-status': isStatus }">
          ...
          <!-- 商品评论 好评率 -->
          <div class="shop-info-evaluate" v-if="data.baseLabel.comment">
          ...
          <div class="shop-info-price" >
            ...
            <div class="price">
              ...
              <span class="price">{{ setPrice(getFinalPrice)[0] }}</span>
              <span class="decimal" v-if="getFinalPrice < 10000">.{{ setPrice(getFinalPrice)[1] }}</span>
            </div>
            <!-- 无活动优惠券时只有原价 -->
            <div class="price oldPrice" v-if="actType || couponType">
              <!-- 当不是满减满折活动，又没有优惠券时划线 -->
          ...
          <div class="shop-info-buy" v-if="data.baseLabel.salesVolume">
            <span>热销{{ data.baseLabel.salesVolume | filterFraction(1) }}</span>
          </div>
          <!-- 活动 -->
          <!-- <div class="shop-info-active" v-if="isMarkIngLabel"> -->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // 卡券信息
      isCouponLable() {
        return this.data && this.data.couponLable
      },
      // 活动信息
      isMarkIngLabel() {
